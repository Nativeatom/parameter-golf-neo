...
To normalize the training data using the text normalization pipeline:

```bash
python normalize_dataset.py \
    --dataset_dir ../../../data/datasets/{src_dataset} \
    --split train \
    --output ../../../data/datasets/{trg_dataset} \
    --tokenizer ../../../data/tokenizers/{tokenizer.model} \
    --vocab-size 8192 \
    --seq-len 8192 \
    --num-workers 4
```
